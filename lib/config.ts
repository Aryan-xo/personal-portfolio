...
export const config = {
  ...
  identity: {
    ...
    summary: [
      "Software engineer at Loop Health, building the infrastructure other",
      "services depend on: a communications layer moving 200K+ notifications a",
      "month across SMS, WhatsApp, email and Slack; an event-driven biomarker",
      "pipeline on Pub/Sub and Temporal; and a semantic retrieval layer over a",
      "Neo4j graph of 50K+ patient-biomarker relationships that keeps an LLM's",
      "answers pinned to facts it can actually cite.",
      "",
      "I ship what sits on top of it too — twenty React Native screens across iOS",
      "and Android, driven by a server-side state machine so the flows can change",
      "without shipping a release.",
      "",
      "I came to this sideways. My degree from IIT Bombay is in Metallurgical",
      "Engineering, with a minor in Machine Learning and Data Science. Before Loop",
      "I trained propensity models on 10B+ ad impressions at Mobavenue, shaped",
      "product strategy for a brokerage at PhillipCapital, and spent a summer in",
      "Nagoya building supercapacitor electrodes that reached 4.65x the industry",
      "standard. The through-line is that I like being dropped into an unfamiliar",
      "domain and coming out with something that runs in production.",
      "",
