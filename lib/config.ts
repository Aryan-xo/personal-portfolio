...
export const config = {
  ...
  identity: {
    ...
    summary: [
      "I'm the go-to person. Work problems, personal ones, the thing someone",
      "hasn't worked out how to ask yet — it tends to find its way to me, and I'd",
      "rather it did.",
      "",
      "I learn by breaking things. Slower than reading the manual, and I've never",
      "found anything that sticks better. Hand me a problem with too many moving",
      "parts and I'll be happy for a week.",
      "",
      "Outside that I take pictures, mostly at night. Astrophotography is a lot of",
      "waiting and one clear sky a month to get it right, which suits me fine. And",
      "I travel — the plan is every country on the map. I know how that sounds.",
      "I'm doing it anyway.",
      "",
      "Type `experience`, `projects` or `research` if you want the work.",
    ],
  },
  ...
  interests: [
    "Photography, and astrophotography when the sky cooperates",
    "Travelling — the plan is every country on the map",
